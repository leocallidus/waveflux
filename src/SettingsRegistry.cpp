...
void SettingsRegistry::initDescriptors()
{
    ...
    m_groups = {
        ...
        {QStringLiteral("lyrics"), QStringLiteral("playback"), QStringLiteral("settings.lyrics"), QString(), 4, false},
    ...
    m_settings = {
        ...
        {QStringLiteral("lyricsPanelVisible"), QStringLiteral("playback"), QStringLiteral("lyrics"), QStringLiteral("menu.viewLyrics"), QStringLiteral("settings.lyricsPanelVisibleDescription"), {}, 20, QStringLiteral("switch"), {}, QString(), QStringLiteral("playback"), {}},
        {QStringLiteral("lyricsSeparateWindow"), QStringLiteral("playback"), QStringLiteral("lyrics"), QStringLiteral("settings.lyricsSeparateWindow"), QStringLiteral("settings.lyricsSeparateWindowDescription"), {}, 21, QStringLiteral("switch"), {}, QString(), QStringLiteral("playback"), {}},
        {QStringLiteral("lyricsInfoPanelVisible"), QStringLiteral("playback"), QStringLiteral("lyrics"), QStringLiteral("settings.lyricsInfoPanelVisible"), QStringLiteral("settings.lyricsInfoPanelVisibleDescription"), {}, 22, QStringLiteral("switch"), {}, QString(), QStringLiteral("playback"), {}},
        ...
        // System & Tools
        {QStringLiteral("system.desktop.closeToTray"), QStringLiteral("system"), QStringLiteral("system.desktop"), QStringLiteral("settings.closeToTray"), QStringLiteral("settings.closeToTrayDescription"), {}, 0, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.desktop.minimizeToTray"), QStringLiteral("system"), QStringLiteral("system.desktop"), QStringLiteral("settings.minimizeToTray"), QStringLiteral("settings.minimizeToTrayDescription"), {}, 1, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.desktop.startMinimizedToTray"), QStringLiteral("system"), QStringLiteral("system.desktop"), QStringLiteral("settings.startMinimizedToTray"), QStringLiteral("settings.startMinimizedToTrayDescription"), {}, 2, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.window.separateDialogs"), QStringLiteral("system"), QStringLiteral("system.window"), QStringLiteral("settings.separateWindowDialogs"), QStringLiteral("settings.separateWindowDialogsDescription"), {}, 3, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.window.keepAboveWhilePlaying"), QStringLiteral("system"), QStringLiteral("system.window"), QStringLiteral("settings.keepAboveWhilePlaying"), QStringLiteral("settings.keepAboveWhilePlayingDescription"), {}, 4, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.window.alwaysKeepAbove"), QStringLiteral("system"), QStringLiteral("system.window"), QStringLiteral("settings.alwaysKeepAbove"), QStringLiteral("settings.alwaysKeepAboveDescription"), {}, 5, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.updates.autoCheck"), QStringLiteral("system"), QStringLiteral("system.updates"), QStringLiteral("settings.autoCheckUpdates"), QStringLiteral("settings.autoCheckUpdatesDescription"), {}, 6, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.updates.prerelease"), QStringLiteral("system"), QStringLiteral("system.updates"), QStringLiteral("settings.includePrereleaseUpdates"), QStringLiteral("settings.includePrereleaseUpdatesDescription"), {}, 7, QStringLiteral("switch"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.updates.checkNow"), QStringLiteral("system"), QStringLiteral("system.updates"), QStringLiteral("settings.checkUpdatesNow"), QStringLiteral("settings.checkUpdatesNowDescription"), {}, 8, QStringLiteral("action"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.tools.ytDlpPath"), QStringLiteral("system"), QStringLiteral("system.tools"), QStringLiteral("settings.ytDlpExecutablePath"), QStringLiteral("settings.ytDlpExecutablePathDescription"), {}, 9, QStringLiteral("path"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.tools.ffmpegPath"), QStringLiteral("system"), QStringLiteral("system.tools"), QStringLiteral("settings.ffmpegExecutablePath"), QStringLiteral("settings.ffmpegExecutablePathDescription"), {}, 10, QStringLiteral("path"), {}, QString(), QStringLiteral("system"), {}},
        {QStringLiteral("system.tools.importRuntimePolicy"), QStringLiteral("system"), QStringLiteral("system.tools"), QStringLiteral("settings.importRuntimeVersionPolicy"), QStringLiteral("settings.importRuntimeVersionPolicyDescription"), {}, 11, QStringLiteral("combo"), {}, QString(), QStringLiteral("system"), {}},
