...
const QVector<Definition> &definitionStorage()
{
    static const QVector<Definition> definitions = {
        ...
        {QStringLiteral("view.toggleLyrics"), QStringLiteral("lyrics.toggleLyrics"), QStringLiteral("navigation"), QStringLiteral("window"), QStringLiteral("Ctrl+Alt+L"), true, true, {}, QStringLiteral("qml/Main.qml Action"), {}},
        ...
        {QStringLiteral("playback.previousChapter"), QStringLiteral("player.previousChapter"), QStringLiteral("playback"), QStringLiteral("window"), QStringLiteral("Alt+PgUp"), true, true, {}, QStringLiteral("qml/Main.qml Action"), {}},
        {QStringLiteral("playback.nextChapter"), QStringLiteral("player.nextChapter"), QStringLiteral("playback"), QStringLiteral("window"), QStringLiteral("Alt+PgDown"), true, true, {}, QStringLiteral("qml/Main.qml Action"), {}},
        ...
        {QStringLiteral("playback.setFragmentStart"), QStringLiteral("shortcut.setFragmentStart"), QStringLiteral("playback"), QStringLiteral("application"), QStringLiteral("Ctrl+["), true, true, {}, QStringLiteral("qml/Main.qml Shortcut"), {}},
        {QStringLiteral("playback.setFragmentEnd"), QStringLiteral("shortcut.setFragmentEnd"), QStringLiteral("playback"), QStringLiteral("application"), QStringLiteral("Ctrl+]"), true, true, {}, QStringLiteral("qml/Main.qml Shortcut"), {}},
        {QStringLiteral("playback.toggleFragmentRepeat"), QStringLiteral("shortcut.toggleFragmentRepeat"), QStringLiteral("playback"), QStringLiteral("application"), QStringLiteral("Alt+L"), true, true, {}, QStringLiteral("qml/Main.qml Shortcut"), {}},
        {QStringLiteral("playback.clearFragmentBoundaries"), QStringLiteral("shortcut.clearFragmentBoundaries"), QStringLiteral("playback"), QStringLiteral("application"), QStringLiteral("Ctrl+Shift+L"), true, true, {}, QStringLiteral("qml/Main.qml Shortcut"), {}},
